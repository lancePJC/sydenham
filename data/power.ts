...
export interface Product {
  ...
  retail: number;
  wholesale: number;
  type: 'light' | 'battery' | 'inverter' | 'accessory';
  images: StaticImageData[];
}

export const products: Product[] = [
  { id: 1, code: 'HA-50W', name: '50 W Solar Flood Light', desc: '4500 lm • LiFePO₄ 10 Ah • IP65 • 12 h run‑time • 3 y warranty', retail: 5250, wholesale: 3500, type: 'light', images: [lightHa50w] },
  { id: 2, code: 'HA-100W', name: '100 W Solar Flood Light', desc: '5500 lm • LiFePO₄ 15 Ah • IP65 • 12 h run‑time • 3 y warranty', retail: 8250, wholesale: 5500, type: 'light', images: [lightHa100w] },
  { id: 3, code: 'HA-200W', name: '200 W Solar Flood Light', desc: '8500 lm • LiFePO₄ 20 Ah • IP65 • 18 h run‑time • 3 y warranty', retail: 12750, wholesale: 8500, type: 'light', images: [lightHa200w] },
  { id: 4, code: 'HA-400W', name: '400 W Solar Flood Light', desc: '64000 lm • LiFePO₄ 40 Ah • IP65 • 24 h run‑time • 3 y warranty', retail: 21750, wholesale: 14500, type: 'light', images: [lightHa400w] },
  { id: 5, code: 'HE-60W', name: '60 W Solar Street Light', desc: '20000 mAh • 18 h run‑time • IP65 • 3 y warranty', retail: 8850, wholesale: 5900, type: 'light', images: [lightHe60w] },
  { id: 6, code: 'HE-90W', name: '90 W Solar Street Light', desc: '25000 mAh • 18 h run‑time • IP65 • 3 y warranty', retail: 10500, wholesale: 7000, type: 'light', images: [lightHe90w] },
  { id: 7, code: 'HO-5W-1', name: '5 W Solar Garden Light', desc: '30 LEDs • 6 Ah • 30‑36 h run‑time • 3 y warranty', retail: 6000, wholesale: 4000, type: 'light', images: [lightHoGarden1] },
  { id: 8, code: 'HO-5W-2', name: '5 W Solar Garden Light', desc: '30 LEDs • 6 Ah • 30‑36 h run‑time • 3 y warranty', retail: 6000, wholesale: 4000, type: 'light', images: [lightHoGarden2] },
  { id: 9, code: 'HO-5W-3', name: '5 W Solar Garden Light', desc: '30 LEDs • 6 Ah • 30‑36 h run‑time • 3 y warranty', retail: 6000, wholesale: 4000, type: 'light', images: [lightHoGarden3] },
  { id: 10, code: 'HO-5W-4', name: '5 W Solar Garden Light', desc: '30 LEDs • 6 Ah • 30‑36 h run‑time • 3 y warranty', retail: 6000, wholesale: 4000, type: 'light', images: [lightHoGarden4] },
  { id: 11, code: 'HO-5W-5', name: '5 W Solar Garden Light', desc: '30 LEDs • 6 Ah • 30‑36 h run‑time • 3 y warranty', retail: 6000, wholesale: 4000, type: 'light', images: [lightHoGarden5] },
  { id: 12, code: 'HO-5W-6', name: '5 W Solar Garden Light', desc: '30 LEDs • 6 Ah • 30‑36 h run‑time • 3 y warranty', retail: 6000, wholesale: 4000, type: 'light', images: [lightHoGarden6] },
  { id: 13, code: 'SR07', name: 'Firefly 0.3 W Kit', desc: 'Panel 0.3 W • LiFePO₄ 400 mAh • 2 y warranty', retail: 1800, wholesale: 1200, type: 'accessory', images: [kitSr07] },
  { id: 14, code: 'SR31E', name: 'Apollo E Solar Home System', desc: 'Panel 50 W • 12 V 12 Ah • TV+Fan bundle', retail: 24485, wholesale: 16323, type: 'accessory', images: [kitSr31e] },
  { id: 15, code: 'LIB-51.2/100', name: 'LiFePO₄ Battery 51.2 V 100 Ah (5 kWh)', desc: '6000 cycles • RS‑485/Can', retail: 213000, wholesale: 142000, type: 'battery', images: [batt51v100ah] },
  { id: 16, code: 'LIB-12.8/200', name: 'LiFePO₄ Battery 12.8 V 200 Ah (2.5 kWh)', desc: '6000 cycles • LCD BMS', retail: 90000, wholesale: 60000, type: 'battery', images: [batt12v200ah] },
  { id: 17, code: 'LIB-12.8/100', name: 'LiFePO₄ Battery 12.8 V 100 Ah', desc: 'Standard battery • long cycle life', retail: 42000, wholesale: 28000, type: 'battery', images: [batt12v100ah] },
  { id: 18, code: 'GLORY‑M3', name: '3 kW Hybrid Inverter', desc: 'PV 4 kW • WiFi/GPRS • 24 Vdc', retail: 59250, wholesale: 39500, type: 'inverter', images: [invGlory3kw] },
  { id: 19, code: 'HMII‑5.5', name: '5.5 kW Hybrid Inverter', desc: 'Surge 16 kW • 500 V MPPT • 48 Vdc', retail: 112500, wholesale: 75000, type: 'inverter', images: [invHmii5kw] },
  { id: 20, code: 'SR02', name: 'Solar Torch SR02', desc: '2W/5V Panel • LiFePO₄ 600mAh • 40lm torch, 20lm reading light • 2.5–5 h run‑time • 2 y warranty', retail: 2400, wholesale: 1600, type: 'accessory', images: [torchSr02] },
  { id: 21, code: 'SR25', name: 'U‑Box Solar Kit', desc: '8W Panel • 4400mAh LiFePO₄ • 3x LED bulbs • Power radio + phone charger • 1 y warranty', retail: 8700, wholesale: 5800, type: 'accessory', images: [kitSr25] },
  { id: 22, code: 'K088T1', name: 'YelloBox Kit', desc: '10W Panel • 6000mAh LiFePO₄ • 4x LED bulbs • Power radio + phone charger • 1 y warranty', retail: 15300, wholesale: 10200, type: 'accessory', images: [kitK088t1] },
  { id: 23, code: 'SR32F', name: 'M Box F Solar System', desc: '150W Panel • 60Ah LiFePO₄ • TV + Radio + Fan + Fridge • 1 y warranty', retail: 81750, wholesale: 54500, type: 'accessory', images: [kitSr32f] },
  { id: 24, code: 'F170', name: 'F170 Solar Radio', desc: 'MP3 + FM/AM/SW • Li-ion 1500mAh • 6–8 h play time • 1 y warranty', retail: 1800, wholesale: 1200, type: 'accessory', images: [radioF170] },
  { id: 25, code: 'BC-90', name: 'BC-90 Solar Fridge', desc: '12V • 90L capacity (76L Fridge / 14L Freezer) • Class A+ • 1 y warranty', retail: 83250, wholesale: 55500, type: 'accessory', images: [fridgeBc90] },
  { id: 26, code: 'PS-TV24', name: '24″ DC Solar TV', desc: '24″ DLED • 13W • 9–15V DC • HDMI, USB, AV, VGA • 2 y warranty', retail: 30150, wholesale: 20100, type: 'accessory', images: [tv24inch] },
  { id: 27, code: 'PS-FP16', name: '16″ DC Pedestal Fan', desc: '16″ • DC 12V • Brushless motor • 10W • 3 speeds • 1 y warranty', retail: 9000, wholesale: 6000, type: 'accessory', images: [fan16inch] },
  { id: 28, code: 'GLORY-M5', name: '5 kW Hybrid Inverter (GLORY M)', desc: 'MPPT • 48V • Surge 10kVA • Remote monitoring • Parallel 12 units', retail: 82500, wholesale: 55000, type: 'inverter', images: [invGlory5kw] },
  { id: 29, code: 'FT-30212', name: '3 kW Pure Sine Wave Inverter', desc: '12V • Surge 9kW • 220VAC • Pure sine wave • 50Hz • Charger 35A', retail: 82500, wholesale: 55000, type: 'inverter', images: [invFt30212] },
  { id: 30, code: 'FTS-10224M30', name: '1 kW Pure Sine Wave Inverter', desc: '12V/24V • MPPT solar controller • 840W input • 30V charger', retail: 87000, wholesale: 58000, type: 'inverter', images: [invFts10224m30] },
  { id: 31, code: 'TG-200-30224M60', name: '3 kW Pure Sine Wave Inverter', desc: '24V • MPPT 30–150V • Surge 9kW • 220V output • 60A MPPT', retail: 82500, wholesale: 55000, type: 'inverter', images: [invTg200] },
  { id: 32, code: 'HMII-30KW', name: '30 kW Hybrid Inverter (HX)', desc: 'MPPT • 210–300V input • 90kW Surge • 28000W Solar • ≤650V', retail: 562500, wholesale: 375000, type: 'inverter', images: [invHmii30kw] },
  { id: 33, code: 'MPPT-10A', name: 'MPPT Controller 10A', desc: '12/24V • Auto recognition • LCD display • USB output', retail: 9450, wholesale: 6300, type: 'accessory', images: [mppt10a] },
  { id: 34, code: 'MPPT-20A', name: 'MPPT Controller 20A', desc: '12/24V • Auto recognition • LCD display • USB output', retail: 9750, wholesale: 6500, type: 'accessory', images: [mppt10a] },
  { id: 35, code: 'MPPT-30A', name: 'MPPT Controller 30A', desc: '12/24V • Auto recognition • LCD display • USB output', retail: 10200, wholesale: 6800, type: 'accessory', images: [mppt10a] },
  { id: 36, code: 'MPPT-40A', name: 'MPPT Controller 40A', desc: '12/24V/48V • LCD • USB • Overload protection', retail: 16200, wholesale: 10800, type: 'accessory', images: [mppt10a] },
  { id: 37, code: 'MPPT-50A', name: 'MPPT Controller 50A', desc: '12/24V/48V • LCD • USB • Overload protection', retail: 18000, wholesale: 12000, type: 'accessory', images: [mppt10a] },
  { id: 38, code: 'MPPT-60A', name: 'MPPT Controller 60A', desc: '12/24V/48V • LCD • USB • Overload protection', retail: 22500, wholesale: 15000, type: 'accessory', images: [mppt10a] },
  { id: 39, code: 'MPPT-80A', name: 'MPPT Controller 80A', desc: '12/24V/48V • LCD • USB • Overload protection', retail: 22500, wholesale: 15000, type: 'accessory', images: [mppt10a] },
  { id: 40, code: 'LIB-51.2/184', name: 'LiFePO₄ Battery 51.2 V 184 Ah (9.4 kWh)', desc: '6000 cycles • Smart BMS • RS‑485/Can', retail: 345000, wholesale: 230000, type: 'battery', images: [batt51v184ah] },
  { id: 41, code: 'DRIP-1/8', name: 'Drip Irrigation Kit – 1/8 Acre', desc: 'Includes tubing, drippers, connectors. Ideal for tomatoes, cabbages. 2 drips/bed', retail: 27657, wholesale: 18438, type: 'accessory', images: [drip] },
];
