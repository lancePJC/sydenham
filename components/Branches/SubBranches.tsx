...
import {
  ...
  FaGlassWhiskey, FaBuilding, FaTools, FaHardHat, FaWarehouse,
  FaRoad, FaLaptopCode, FaCodeBranch, FaPlug, FaChargingStation,
  FaBatteryFull, FaLightbulb, FaSolarPanel, FaHeart, FaCoffee, FaBolt,
  FaFan 
} from 'react-icons/fa';
    ...
    <div className="bg-black text-white px-6 md:px-16 py-16 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <header className="mb-12 text-center">
          <h1 className="text-4xl font-bold text-yellow-500">Our Sub‑Branches</h1>
          <p className="text-gray-300 mt-2">
            Explore subcategories in detail under each branch
          </p>
        </header>

        <div className="space-y-16">
          {subBranches.map((group) => (
