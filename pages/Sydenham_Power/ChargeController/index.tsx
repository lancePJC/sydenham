...
export default function ChargeController() {
  const chargeControllers = products.filter((product) => product.name.includes('MPPT Controller'));
  ...
  return (
    <>
      <Head>
        <title>Charge Controllers | Solar Energy Solutions</title>
      </Head>
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          <section className="text-center space-y-4">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Optimize your solar energy system with efficient MPPT charge controllers.
            </p>
          </section>
          <section>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {chargeControllers.map((product) => (
                <div
                  key={product.id}
