...
export default function SolarTV() {
  const solarTVs = products.filter((product) => product.name.includes('Solar TV'));
  ...
  return (
    <>
      <Head>
        <title>Solar TVs | Solar Entertainment Solutions</title>
      </Head>
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          <section className="text-center space-y-4">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Eco-friendly entertainment with solar-powered televisions.
            </p>
          </section>
          <section>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {solarTVs.map((product) => (
                <div
                  key={product.id}
