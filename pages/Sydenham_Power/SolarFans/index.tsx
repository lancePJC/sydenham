...
export default function SolarFans() {
  const solarFans = products.filter((product) => product.name.includes('Pedestal Fan'));
  ...
  return (
    <>
      <Head>
        <title>Solar Fans | Solar Cooling Solutions</title>
      </Head>
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          <section className="text-center space-y-4">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Stay cool with energy-efficient solar-powered fans.
            </p>
          </section>
          <section>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {solarFans.map((product) => (
                <div
                  key={product.id}
