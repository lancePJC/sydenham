...
const PrettySkinPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6">Pretty Skin Products</h1>
      {prettySkinProducts.length === 0 ? (
        <p className="text-gray-600">No Pretty Skin products available.</p>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {prettySkinProducts.map((item: SkincareItem) => {
