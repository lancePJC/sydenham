...
const PyunkangYulPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6">Pyunkang Yul Products</h1>
      {pyunkangProducts.length === 0 ? (
        <p className="text-gray-600">No Pyunkang Yul products available.</p>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {pyunkangProducts.map((item: SkincareItem) => {
...
export default PyunkangYulPage;
